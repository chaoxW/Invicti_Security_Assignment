...
describe("Tab order", function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            it("Verify all element's tab order", function () {
                return __awaiter(this, void 0, void 0, function () {
                    var els;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                protractor_1.browser.ignoreSynchronization = true; //we are testing non-angular site
                                protractor_1.browser.get("https://qavbox.github.io/demo/signup/");
                                return [4 /*yield*/, new SignupPage_1.SignupPage().getTabElements()];
                            case 1:
                                els = _a.sent();
                                ...
                                return [4 /*yield*/, Util_1.Util.verify_TabOrder(els)];
                            case 2:
                                /*for(var i=0; i < (els.length-1); i++){
                                    console.log("Before Tab - " + await els[i].getId());
                                    //await els[i].sendKeys(protractor.Key.TAB);
